...
CAPABILITIES = [
    ...
    {"name": "node.create", "version": "1.0", "write": True, "risk": "L2", "rollback": True, "verification": True, "manages_checkpoint": True, "tested_host_versions": ["21.0"]},
    {"name": "node.delete", "version": "1.0", "write": True, "risk": "L2", "rollback": True, "verification": True, "tested_host_versions": ["21.0"]},
    {"name": "node.connect", "version": "1.0", "write": True, "risk": "L2", "rollback": True, "verification": True, "manages_checkpoint": True, "tested_host_versions": ["21.0"]},
    {"name": "node.disconnect", "version": "1.0", "write": True, "risk": "L2", "rollback": True, "verification": True, "manages_checkpoint": True, "tested_host_versions": ["21.0"]},
